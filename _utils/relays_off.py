#!/usr/bin/env python
"""     Allow you to quickly switch one or all relays off for a given serial port
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print "_utils/relays_off.py <SERIALPORT>        - For all"
        print "_utils/relays_off.py <SERIALPORT>:<PORT> - For one"
    ...
    con.write(USB_RLY16['off'][powerport])
